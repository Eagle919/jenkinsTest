...
KISBPM.URL = {
    ...
    saveModelResouce: function(modelId) {
        return ACTIVITI.CONFIG.contextRoot + '/model/' + modelId + '/saveRresource';
    },

    delModel: function(modelId) {
        return ACTIVITI.CONFIG.contextRoot + '/model/' + modelId + '/delete';
    },
    deploy: function(modelId) {
        return ACTIVITI.CONFIG.contextRoot + '/model/' + modelId + '/deploy';
    },
    start: function(modelId) {
        return ACTIVITI.CONFIG.contextRoot + '/model/' + modelId + '/start';
    }
};